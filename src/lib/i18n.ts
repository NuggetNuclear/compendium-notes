...
export const translations = {
    ...
    'app.history.subtitle': {
        es: 'Todo lo que has transcrito se guarda en este navegador.',
        en: 'Everything you have transcribed is stored in this browser.',
    },
    'app.history.search': { es: 'Buscar por título o archivo', en: 'Search by title or file' },
    'app.history.empty': { es: 'Todavía no hay nada guardado', en: 'Nothing saved yet' },
    'app.history.empty.desc': {
        es: 'Cuando transcribas una clase aparecerá aquí, con su audio y su transcripción.',
        en: 'Once you transcribe a recording it will show up here, with its audio and transcript.',
    },
    'app.history.no_results': { es: 'Ningún archivo coincide', en: 'No files match' },
    'app.history.open_notes': { es: 'Abrir apuntes', en: 'Open notes' },
    'app.history.transcript': { es: 'Transcripción', en: 'Transcript' },
    'app.history.hide_transcript': { es: 'Ocultar transcripción', en: 'Hide transcript' },
    'app.history.audio': { es: 'Descargar audio', en: 'Download audio' },
    'app.history.delete': { es: 'Eliminar', en: 'Delete' },
    'app.history.delete_confirm': { es: '¿Eliminar definitivamente?', en: 'Delete permanently?' },
    'app.history.delete_yes': { es: 'Sí, eliminar', en: 'Yes, delete' },
    'app.history.delete_no': { es: 'Cancelar', en: 'Cancel' },
    'app.history.gone': { es: 'Estos apuntes ya no existen', en: 'These notes no longer exist' },
    'app.history.no_notes': { es: 'Sin apuntes generados', en: 'No notes generated' },
    'app.history.words': { es: 'palabras', en: 'words' },
    'app.history.count': { es: 'archivos', en: 'files' },
    'app.history.close': { es: 'Cerrar', en: 'Close' },
    'app.history.status.done': { es: 'Completado', en: 'Completed' },
    'app.history.status.processing': { es: 'A medias', en: 'Unfinished' },
    'app.history.status.error': { es: 'Falló', en: 'Failed' },
    'app.history.status.cancelled': { es: 'Cancelado', en: 'Cancelled' },
    'app.history.status.draft': { es: 'Borrador', en: 'Draft' },
    'app.history.today': { es: 'Hoy', en: 'Today' },
    'app.history.yesterday': { es: 'Ayer', en: 'Yesterday' },
    'app.history.audio_gone': { es: 'Audio no disponible', en: 'Audio unavailable' },
    'app.history.storage': { es: 'ocupado por los audios', en: 'used by audio files' },
